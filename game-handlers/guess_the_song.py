...
class GuessTheSongGame:
    ...
    def _load_songs(self):
        ...
        json_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "assets", "guess-the-song", "songs.json")
        try:
    ...
    def start_new_round(self) -> Optional[Tuple[str, int]]:
        ...
        audio_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "assets", "guess-the-song", self.current_song["audio_file"])
    ...
    def get_song_info(self) -> Optional[Dict]:
        ...
        cover_path = os.path.join(
            os.path.dirname(os.path.dirname(__file__)), "assets", "guess-the-song", "covers", self.current_song.get("cover_file", "")
        )
        return {
